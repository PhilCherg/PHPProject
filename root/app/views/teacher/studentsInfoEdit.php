    ...
    <body>
        <div class="content">
            ...
            <div id="form">
                ...
                <form action="/PHPProject/root/public/teacher/studentsInfoEditSubmit" method="POST">
                    ...
                    <a href="../../teacher/studentsInfo/<?php echo $data['assignment'][0]['student_id'];?>"><input type="button" class="buttonInput leftButton blueButton" value="Back"></a>
